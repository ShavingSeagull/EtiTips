...
class EuropeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        europeList.add(CountryCardItem(R.drawable.canada_recycler, "Canada (Europe)"))
        europeList.add(CountryCardItem(R.drawable.dummy_recycler, "Dummy Nation"))
        europeList.add(CountryCardItem(R.drawable.dummy_recycler, "Dummy Nation"))
        ...
        mAdapter = CountryCardAdapter(europeList)
